      ...
      <section className="py-[5rem] wrapper grid gap-10 lg:grid-cols-2">
        <div className="flex flex-col text-white">
          ...
          <p data-aos="fade-right" className="description mt-4">
            At Aithrown, we are dedicated to pushing the limits of technological
            innovation with our advanced AI and digital solutions. As leaders in
            artificial intelligence, blockchain, AR/VR, game development, and
            IoT, we leverage our expertise to transform your visionary ideas
            into groundbreaking realities.
            <br />
